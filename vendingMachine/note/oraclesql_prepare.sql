BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE BEVERAGE_ORDER';
  EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE BEVERAGE_MEMBER';
  EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE BEVERAGE_GOODS';
  EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE BEVERAGE_GOODS_SEQ';
  EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE BEVERAGE_ORDER_SEQ';
  EXCEPTION
    WHEN OTHERS THEN NULL;
END;
/
