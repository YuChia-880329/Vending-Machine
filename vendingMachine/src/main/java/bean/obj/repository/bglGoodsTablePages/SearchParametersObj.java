package bean.obj.repository.bglGoodsTablePages;
...
public class SearchParametersObj {
	...
	public SearchParametersObj() {
	}
	public SearchParametersObj(Integer idMin, Integer idMax, String name, Integer priceMin, Integer priceMax,
