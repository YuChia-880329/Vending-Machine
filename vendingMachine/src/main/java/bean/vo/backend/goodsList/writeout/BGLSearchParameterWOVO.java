...
public class BGLSearchParameterWOVO {
	...
	public BGLSearchParameterWOVO() {
	}
	public BGLSearchParameterWOVO(String idMin, String idMax, String name, String priceMin, String priceMax,
