...
public class BGLUrlService {

	private static final BGLUrlService INSTANCE = new BGLUrlService();
	
	private BGLUrlService() {
	}
	
	public static BGLUrlService getInstance() {
	...
	public Function<Integer, String> getUrlFctn(String url, BGLPageParameterRIVODTO pageParameter){
