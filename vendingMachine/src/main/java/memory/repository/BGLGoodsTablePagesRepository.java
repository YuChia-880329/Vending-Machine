...
import service.memory.repository.bglGoodsTablePages.SearchParametersService;
import service.model.GoodsModelService;
import template.memory.repository.RepositoryTemplate;
import template.model.QueryObj;
import transformer.obj.bglGoodsTablePages.writeout.GoodsObjTransformer;
import util.PaginationUtil;

public class BGLGoodsTablePagesRepository extends RepositoryTemplate<GoodsTablePagesInputObj, GoodsTablePagesObj> {
